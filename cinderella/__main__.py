...
if START_IMG is None:
    img = "https://telegra.ph/file/6f3aa9464e81135326de5.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help🤗",callback_data="help_back"),InlineKeyboardButton(text="Founder👿",url="https://t.me/call_me_logi")]]
    ...
    keyboard += [[InlineKeyboardButton(text="Chatting Club🥰",url="https://t.me/Chatting_club420")]]
